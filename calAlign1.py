...
# linThreshold = 66000
# mode = "FAST"
# a=cnH2rgRamps("data/calibrations/spAlign1.*",
...
# linThreshold = 66000
# mode = "FAST"
# a=cnH2rgRamps("data/calibrations/ciAlign1.*",
#             "fits",readMode=mode,subArray=None,verbose=True, cssStyle=True,
#             ramps=50, ndr=3)
# data = np.squeeze(a.read("fits",dtype=np.uint16))
# #%%
# # reading the background data
# b=cnH2rgRamps("data/calibrations/ciFast3-masterBackgroundDark",
#               "fits",readMode=mode,subArray=None,verbose=True, cssStyle=True,
#               ramps=1, ndr=3)
# backgroundDark=np.squeeze(b.read("fits",dtype=np.float32))

# #%%
# gainTable = fits.open("data/calibrations/ciMasterGain1.000.fits")[0].data.astype(np.float32)
